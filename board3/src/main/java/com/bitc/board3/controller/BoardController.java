...
public class BoardController {
  // RESTful : 자원의 이름으로 구분하여 해당 자원의 정보를 주고 받는 것
  ...
  // @RequestMapping 어노테이션 사용 시 value 속성을 사용하여 URI를 설정하고, method 속성을 사용하여 GET, POST, PUT, DELETE를 설정
  // @GetMapping, @PostMapping, @PutMapping, @DeleteMapping 을 사용하여 구분해도 됨

  // 전체 URL 생성 방법 :
  // 서버URL:포트번호:기본 주소/추가주소or게시물 번호/게시물번호
  ...
  // 게시물 상세 내용 보기
  // {boardIdx} : 게시물 번호, 해당 게시물 번호에 대한 자원에 접근
  // @PathVariable : 지정한 자원 이름과 Controller가 가지고 있는 메소드의 매개변수명을 매칭시켜주는 어노테이션. 해당 자원의 데이터를 가져와서 메소드의 매개변수에 저장
