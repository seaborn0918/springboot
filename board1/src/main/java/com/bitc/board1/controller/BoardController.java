...
// 스프링6 (스프링부트3)로 변경되면서 javax 패키지에서 jakarta 패키지로 모두 변경됨
...
// @Controller : 일반적인 SOAP 방식의 HTTP 응답처리를 할 경우 사용함, get/post 2 가지를 사용
...
public class BoardController {
  ...
  // @RequestParam 어노테이션을 여러 개 사용하여 파라미터 값 전달 가능
  // 지정한 게시글 상세 보기
  ...
  public ModelAndView openBoardDetail(@RequestParam int boardIdx) throws Exception {
    ...
    // return을 사용하여 ModelAndView 클래스타입의 객체를 클라이언트에 전달
    return mv;
  }
  ...
  // public String insertBoard(@RequestParam String boardTitle, @RequestParam String boardContents, ... ) throws Exception {
