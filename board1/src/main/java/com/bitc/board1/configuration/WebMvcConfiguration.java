...
// WebMvcConfigurer : 스프링 프레임워크에서 사용하는 설정 정보가 있는 인터페이스. 사용자 설정이 필요할 경우 해당 인터페이스를 상속받아 수정
@Configuration
public class WebMvcConfiguration implements WebMvcConfigurer {

  // 스프링6(스프링부트3)에서 CommonsMultipartResolver를 사용할 수 없기 때문에 예전 방식으로 설정 불가능함
//  @Bean
